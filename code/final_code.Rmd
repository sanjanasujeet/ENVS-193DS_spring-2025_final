...
Another important thing to include would be summary statistics, like mean standard error and range, for each group, this would convey important information in the direction and magnitude of differences as well as how spread out the data is. Add Effect size ?????
...
```{r}
pred <- ggpredict(Model3, terms = c("edge_distance [0,900]", "season"))
print(pred)
```
